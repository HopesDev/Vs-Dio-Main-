...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		case 'Bridge':

			{
			   ...
			   defaultCamZoom = 0.8;
                    ...
                    var bg:FlxSprite = new FlxSprite(260, 0).loadGraphic(Paths.image('dio/BridgeBack', 'dio'));
					bg.antialiasing = true;
					...
					var stageFront:FlxSprite = new FlxSprite(-200, 0).loadGraphic(Paths.image('dio/BridgeBridge', 'dio'));
					stageFront.setGraphicSize(Std.int(stageFront.width * 1.6));
					stageFront.updateHitbox();
					stageFront.antialiasing = true;
					stageFront.scrollFactor.set(0.9, 0.9);
					stageFront.active = false;
...

		{
			 ...
			 var bg:FlxSprite = new FlxSprite(300, 200).loadGraphic(Paths.image('dio/morioh_back', 'dio'));
			 bg.antialiasing = true;
			 ...
			 var stageFront:FlxSprite = new FlxSprite(0, 0).loadGraphic(Paths.image('dio/morioh_front', 'dio'));
		...
		switch (curStage)
		{
			...
			case 'schoolEvil':
				...
				case 'Bridge':
					boyfriend = new Boyfriend(1000, 325, SONG.player1);
					boyfriend.y += 325;
					boyfriend.x += 280;
					gf.x += 290;
					camPos.set(boyfriend.getGraphicMidpoint().x + 280, dad.getGraphicMidpoint().y + 325);
					dad.x -= 100;
					dad = new Character (200, 325, SONG.player2);
					gf = new Character (600, 355, gfVersion);
				
				case 'morioh':
					boyfriend.y += 900;
					boyfriend = new Boyfriend(1050, 700, SONG.player1);
					dad = new Character (450, 300, SONG.player2);
					gf = new Character (650, 320, gfVersion);
		}
		...
		kadeEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " " + (storyDifficulty == 2 ? "Hard" : storyDifficulty == 1 ? "Normal" : "Easy") + (Main.watermarks ? " - HR BUILD " + MainMenuState.kadeEngineVer : ""), 16);
...
function stoptime():Void {
	...
	gf.playAnim('danceRight', false);
	gf.playAnim('danceLeft', false);
    
}

function reworktime():Void {
